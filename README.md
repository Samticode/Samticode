...
- 🏫 At my third, out of my four year degree to be an IT-developer

### 🚀 Tech Stack

| Languages | Frameworks | Cloud & Tools | Databases |
|-----------|-----------|---------------|-----------|
...
[View Cv](https://github.com/Samticode/Samticode/blob/main/SamtiCv.pdf)
